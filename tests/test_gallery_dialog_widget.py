...
def test_set_gallery_specific_setting(val_pack, find_combobox_match_result):
    ...
    gallery = [m_g]
    m_cls = mock.Mock()
    from happypanda.gallery_dialog_widget import _set_gallery_specific_setting
    from happypanda.gallery_dialog_widget import app_constants
...
def test_set_gallery_constant_setting():
    ...
    from happypanda.gallery_dialog_widget import _set_gallery_constant_setting
    # run
...
def test_change_link():
    ...
    link_btn1 = mock.Mock()
    link_btn2 = mock.Mock()
    from happypanda.gallery_dialog_widget import GalleryDialogWidget
    # run
...
def test_set_form(mode, attr):
    ...
    with mock.patch('happypanda.gallery_dialog_widget.tag_to_string') as m_tts:
        from happypanda.gallery_dialog_widget import GalleryDialogWidget
        #
        g = mock.Mock()
...
def test_get_gallery_date(raise_index_error):
    ...
    with mock.patch('happypanda.gallery_dialog_widget.datetime') as m_dt:
        from happypanda.gallery_dialog_widget import GalleryDialogWidget
